...
lambda_wave2 = 1/(2/lambda_wave3-1/lambda_wave1); % 2nd wavelength
...
amp_wave2_sqar=PSA*amp_wave1_sqar;
x = 0:0.01:1;

%% Phase-Mismatch and Coherent Lengths

deltak_d = k_wave3_d - k_wave1_d - k_wave2_d ;
deltak_o = deltak_d;
...
%%%%% this section may seem redudndant, although it can be used to
...
A_eff_3_o = 1.0*(A_eff_3_TE+A_eff_3_TM)/2;
