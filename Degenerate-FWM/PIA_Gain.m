function [x_vec,s_gain,signalgain] = PIA_Gain(wl, pump, pl,tpa)
...
amp_wave3_sqar=(1.09375*0.2*pump*0.75*1000)*2^(gradual-1);  %peak power for pulsed pump electric field is square root
