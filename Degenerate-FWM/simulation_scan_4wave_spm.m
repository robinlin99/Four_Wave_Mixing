function [] = simulation_scan_4wave_spm(min,max)
    %% Initialize
    ...
    for l = min:max
        [x_vec30,s_gain30,sig_gain30] = PIA_Gain(l,30,1310,0);
        [x_vec40,s_gain40,sig_gain40] = PIA_Gain(l,40,1310,0);
        [x_vec50,s_gain50,sig_gain50] = PIA_Gain(l,50,1310,0);
        [x_vec60,s_gain60,sig_gain60] = PIA_Gain(l,60,1310,0);
